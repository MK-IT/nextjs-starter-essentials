module.exports = {
  extends: ["airbnb", "airbnb/hooks", "airbnb-typescript", "plugin:@next/next/recommended", "plugin:react/jsx-runtime", "prettier", "plugin:react/jsx-runtime", "plugin:storybook/recommended"],
